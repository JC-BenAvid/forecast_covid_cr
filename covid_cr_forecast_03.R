### Corona virus CR Forecast based on time series and stochastic processes, 28th May 21
...
#loading data
ruta<-#"local path file location\\covid_cr_data_act_28mayo.csv"
...
plot.ts(covid_cr[100:448])
zoom_covid_cr<-ts(covid_cr[100:448])
...
par(mfrow=c(1,1))
plot(forecast(model),xlab= "Days", ylab = "Cases", main= "Forecast Covid Cases CR, May 28th") 
forecast(model,12)
